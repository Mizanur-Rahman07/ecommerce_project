                    ...
                    <div class="product-carousel">
                        ...
                        <div class="single-product">
                            <div class="product-f-image">
                                <img src="{{ asset($product->image) }}" style="width: 100%; height: 280px;" alt="">
                            ...
                            <div class="product-carousel-price">
                                <ins>${{ $product->product_price }}</ins> <del>$999.00</del>
                            </div>
                        </div>
                        @endforeach
        ...
        <div class="row">
                ...
                <div class="single-product-widget">
                    ...
                    <div class="single-wid-product">
                        <a href="{{ route('product-details',['id'=>$product->id])}}"><img
                                src="{{ asset ('frontEndAsset')}}/img/product-thumb-1.jpg" alt=""
                    ...
                    <div class="single-wid-product">
                        <a href="{{ route('product-details',['id'=>$product->id])}}"><img
                                src="{{ asset ('frontEndAsset')}}/img/product-thumb-2.jpg" alt=""
                                class="product-thumb"></a>
                        <h2><a href="{{ route('product-details',['id'=>$product->id])}}">Apple new mac book 2015</a>
                        </h2>
                        <div class="product-wid-rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="single-wid-product">
                        <a href="{{ route('product-details',['id'=>$product->id])}}"><img
                                src="{{ asset ('frontEndAsset')}}/img/product-thumb-3.jpg" alt=""
                                class="product-thumb"></a>
            ...
            <div class="col-md-4">
                <div class="single-product-widget">
                    ...
                    <div class="single-wid-product">
                        <a href="{{ route('product-details',['id'=>$product->id])}}"><img
                                src="{{ asset ('frontEndAsset')}}/img/product-thumb-4.jpg" alt=""
                                class="product-thumb"></a>
                        <h2><a href="{{ route('product-details',['id'=>$product->id])}}">Sony playstation microsoft</a>
                        </h2>
                        <div class="product-wid-rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="single-wid-product">
                        <a href="{{ route('product-details',['id'=>$product->id])}}"><img
                                src="{{ asset ('frontEndAsset')}}/img/product-thumb-1.jpg" alt=""
                                class="product-thumb"></a>
                        <h2><a href="{{ route('product-details',['id'=>$product->id])}}">Sony Smart Air Condtion</a>
                        </h2>
                        <div class="product-wid-rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
