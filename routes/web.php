...
Route::get('/cart', [EcommerceController::class, 'cartSystem'])->name('cart');
Route::get('/checkout', [EcommerceController::class, 'checkoutSystem'])->name('checkout');
Route::get('/category', [EcommerceController::class, 'category'])->name('category');
